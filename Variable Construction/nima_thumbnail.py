# -*- coding: utf-8 -*-
"""
NIMA - thumbnail images
Reference: 'https://github.com/titu1994/neural-image-assessment'
Requirement: download 'https://github.com/titu1994/neural-image-assessment' code
"""
...
from neural_image_assessment_master.utils.score_utils import mean_score, std_score
...
TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, '{i}.jpg'.format(i=i)) for i in imagelist]
...
with tf.device('/CPU:0'):
    ...
    for i in range(len(imagelist)):
        vid= imagelist[i]
        img_path = os.path.join(PATH_TO_TEST_IMAGES_DIR, '{vid}.jpg'.format(vid=vid))
        ...
        score_list.append((vid, file_name, mean, std))
